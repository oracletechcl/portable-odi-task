...
| --- | --- | --- | --- | --- |
| AC-01 | Preserve complete job topology | `pipeline.py`, OCI pipeline object | `test_pipeline.py`, `test_oci_export.py` | Passed: 68-test migrated suite |
...
| AC-09 | Package `HABITAT_SUCURSALES.project.zip` with a `USER_PROJECT` export root | `oci_export.py`, generated OCI objects | `test_oci_export.py`, ZIP integrity, manifest-root checks, OCI import request | Passed: live OCI import `148d9419-b097-4c3b-8f84-9ca05b51ab3d` imported all 10 objects |
