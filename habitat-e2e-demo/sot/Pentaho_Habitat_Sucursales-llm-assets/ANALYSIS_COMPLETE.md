# Code Introspector — Pentaho Habitat Sucursales Portfolio Analysis Delivery
...
This analysis covers **1 software modules** from the **Pentaho Habitat Sucursales** portfolio.
...
```
output/Pentaho Habitat Sucursales/
