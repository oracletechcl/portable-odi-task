...
|---|---|---|---|---:|---|---|
| OCI ODI | OCI | Running on OCI ODI | OCI deployment | 1 | Pentaho Data Integration | Sucursales |
...
|---|---|---|---|---|---|
| Sucursales | Pentaho Data Integration | OCI ODI | Running on OCI ODI | [to-be](./canonical-app-to-be/Sucursales/to-be.md) | [migration-strategy](./canonical-app-to-be/Sucursales/migration-strategy.md) |
