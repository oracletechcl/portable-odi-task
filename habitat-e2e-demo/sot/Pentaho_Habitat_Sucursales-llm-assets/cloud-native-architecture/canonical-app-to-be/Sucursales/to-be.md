# Sucursales — To-Be Cloud-Native Architecture

🏠 [Delivery Home](../../../README.md) | 📘 [Delivery Summary](../../../ANALYSIS_COMPLETE.md) | 🌊 [Migration Waves](../../../strategic-analysis/MIGRATION_WAVES.md) | 🗺️ [Roadmap](../../../modernization-roadmap/Sucursales/roadmap.md) | 📄 [Analysis](../../../app-by-app-analysis/Sucursales/analysis.md) | 🔬 [Deep Dive](../../../app-by-app-analysis/Sucursales/deep-dive.md) | 🚚 [Migration Strategy](./migration-strategy.md) | 🤝 [Co-Living](../../../coliving-strategy/app-by-app/Sucursales/coliving-strategy.md)
...
The target state for `Sucursales` is `OCI ODI using Running on OCI ODI via OCI deployment`. Data, ingress, eventing, security, and observability are taken from the same explicit profile so every downstream to-be document stays aligned.
...
|---|---|---|---|---|
| Runtime workload | Executes `Sucursales` on `OCI` | Inbound business requests, outbound service calls | Legacy runtime footprint | Explicit target profile + analysis |
