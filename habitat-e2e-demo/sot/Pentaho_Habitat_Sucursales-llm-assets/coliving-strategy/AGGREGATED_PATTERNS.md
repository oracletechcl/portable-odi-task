...
|---|---|---|---:|---|
| Database-backed dual-run with GoldenGate | Detected relational state coupling with preferred Oracle GoldenGate change-data-capture bridge. | Legacy and target runtimes must stay state-consistent before any irreversible traffic cutover. | 1 | [Sucursales](./app-by-app/Sucursales/coliving-strategy.md) |
...
| SOAP/API compatibility facade | Detected contract-preserving integration style requiring protocol translation boundary. | Legacy consumers can keep running while modern internals evolve behind a controlled facade. | 1 | [Sucursales](./app-by-app/Sucursales/coliving-strategy.md) |
...
| Recommended: Strangler Fig Incremental | Highest scoring strategy for the app is Strangler Fig Incremental. | Best fit where routing boundaries, phased rollout controls, and manageable contract drift exist. | 1 | [Sucursales](./app-by-app/Sucursales/coliving-strategy.md) |
...
Representative apps: [Sucursales](./app-by-app/Sucursales/coliving-strategy.md)
...
|---:|---|---:|---|
| 1 | sync=Oracle GoldenGate CDC (preferred); integration=Contract-preserving SOAP/API facade; database=yes; events=no | 1 | [Sucursales](./app-by-app/Sucursales/coliving-strategy.md) |
...
|---|---|---|---|---|---:|---|---|---|
| [Sucursales](./app-by-app/Sucursales/coliving-strategy.md) | Wave 1 | Pentaho Data Integration | Strangler Fig Incremental | Baseline recommendation favors incremental over big-bang. ; Routing/API boundary evidence supports phased redirection. | 62 | [To-Be](../cloud-native-architecture/canonical-app-to-be/Sucursales/to-be.md) | [Migration](../cloud-native-architecture/canonical-app-to-be/Sucursales/migration-strategy.md) | [Roadmap](../modernization-roadmap/Sucursales/roadmap.md) |

## Strategy Ranking Evidence Per App

| App | Top-3 Ranked Candidates |
|---|---|
| [Sucursales](./app-by-app/Sucursales/coliving-strategy.md) | Strangler Fig Incremental (62), CDC Replication Bridge (48), Anti-Corruption Layer / Facade (45) |
