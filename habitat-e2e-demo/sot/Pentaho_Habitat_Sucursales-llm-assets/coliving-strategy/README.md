...
|---|---|---|---|---|---|
| Sucursales | Wave 1 | Pentaho Data Integration | [to-be](../cloud-native-architecture/canonical-app-to-be/Sucursales/to-be.md) | [migration-strategy](../cloud-native-architecture/canonical-app-to-be/Sucursales/migration-strategy.md) | [co-living](app-by-app/Sucursales/coliving-strategy.md) |
