# Sucursales — Co-Living Strategy

🏠 [Delivery Home](../../../README.md) | 📘 [Delivery Summary](../../../ANALYSIS_COMPLETE.md) | 🤝 [Co-Living Overview](../../README.md) | 📄 [Analysis](../../../app-by-app-analysis/Sucursales/analysis.md) | 🔬 [Deep Dive](../../../app-by-app-analysis/Sucursales/deep-dive.md) | 🗺️ [Roadmap](../../../modernization-roadmap/Sucursales/roadmap.md) | ☁️ [To-Be](../../../cloud-native-architecture/canonical-app-to-be/Sucursales/to-be.md) | 🚚 [Migration Strategy](../../../cloud-native-architecture/canonical-app-to-be/Sucursales/migration-strategy.md)
...
`Sucursales` should run in a controlled co-living posture where the current `SOAP + WSDL + Oracle + Database` path remains available while the target `OCI ODI` path is validated, synchronized, and progressively promoted.
...
1. Establish a stable ingress boundary for Sucursales and keep contract compatibility at the edge.
...
sequenceDiagram
    ...
    participant Legacy as Legacy Sucursales
