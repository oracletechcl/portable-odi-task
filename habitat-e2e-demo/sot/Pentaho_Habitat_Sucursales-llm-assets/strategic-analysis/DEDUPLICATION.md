...
|---|---|---|---|---|---|---|
| [Sucursales](../modernization-roadmap/Sucursales/roadmap.md) | Pentaho Data Integration | unversioned | - | [Sucursales](../modernization-roadmap/Sucursales/roadmap.md) | 0 | SINGLE |

## Dedup Index (All Apps)

| App ID | Status | Canonical | Proxy / Business Relationship | Reason |
|---|---|---|---|---|
| [Sucursales](../modernization-roadmap/Sucursales/roadmap.md) | **CANONICAL** | - | - | Preferred version for `Sucursales` (0 retired variant(s)) |