# Code Architecture Analysis — Web

## 1. Overview
- **Module**: `Web`
- **Type**: **Source Module**
- **Domain**: Enterprise Services
- **Source Root**: `<source-root>/Web`
- **Artifact Counts**: source=8, xml=0, wsdl=0, sql=0, properties=0, yaml=0
...
flowchart TD
    ...
    service["Service Components<br/>Web"]
