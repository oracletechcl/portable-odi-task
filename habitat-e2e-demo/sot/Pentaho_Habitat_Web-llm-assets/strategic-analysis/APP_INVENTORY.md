# 00 — App Inventory
## Pentaho Habitat Web Portfolio — Strategic Modernization
...
| Metric | Count |
|---|---|
| Discovered applications | 1 |



## Inventory Table

| # | APP_ID | Domain | Type | Complexity | Proxy Services | Business Services | Tech Signals | Priority Tier | Wave |
|---|--------|--------|------|------------|----------------|-------------------|--------------|--------------|------|
| 1 | [Web](../modernization-roadmap/Web/roadmap.md) | Enterprise Services | Source Module | LOW | 0 | 0 | — | T3 – STANDARD | Wave 1 |
