...
|---|---|---|---|---|---|---|---|---|---|
| 1 | [Web](../modernization-roadmap/Web/roadmap.md) | Pentaho Data Integration | - | - | - | Unversioned | 0 | Enterprise Services workload implemented as Source Module | [To-Be](../cloud-native-architecture/canonical-app-to-be/Web/to-be.md) |