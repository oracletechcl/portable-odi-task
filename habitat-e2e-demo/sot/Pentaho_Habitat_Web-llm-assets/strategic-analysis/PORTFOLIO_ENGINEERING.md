...
|---|---|---|---|---|---|
| [Web](../modernization-roadmap/Web/roadmap.md) | Wave 1 | Pentaho Data Integration | T3 – STANDARD | 12 | 0 |

## Highest-Complexity Canonical Apps

| App | Wave | Family | Complexity Score | Description |
|---|---|---|---|---|
| [Web](../modernization-roadmap/Web/roadmap.md) | Wave 1 | Pentaho Data Integration | 12 | Enterprise Services workload implemented as Source Module |
